...
├── Banking Report.docx      </br>         
├── README.md                </br>          
├── Data/                     </br>
│   └── clients_data.csv      </br>          
├── Power BI Dashboards/      </br>
│   └── banking_dashboard.pbix     </br>  
├── Images/                    </br>
│   ├── home-dashboard.png        </br>   
│   ├── loan-dashboard.png         </br>  
│   ├── deposit-dashboard.png     </br>
│   └── summary-dashboard.png      </br>   
├── Python Scripts/               </br>
│   └── data_cleaning.py           </br>   
├── .gitignore              </br>
...
<h1>🙋‍♂️ Developer</h1>
<h4>Mohan Pathlavath</h4> </br Power BI | Python | SQL | MySQ
